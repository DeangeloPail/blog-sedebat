    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4 relative" x-data="{ show: false}">
                ...
                <x-input x-bind:type="[ show ? 'text': 'password' ]" id="password" class="block mt-1 w-full"  name="password" required autocomplete="current-password" />
                <button type="button" class="absolute top-9 text-gray-700 right-3 bg-transparent flex items-center justify-center hover:text-blue-600" @click="show = !show">
